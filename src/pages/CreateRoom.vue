<template>
  <div class="min-h-screen flex flex-col justify-between  px-6 overflow-hidden relative pb-12"
  style="background: linear-gradient(to bottom, #dc2626 2%, #dc2626 2%, #ffffff 40%, #ffffff 100%);">
